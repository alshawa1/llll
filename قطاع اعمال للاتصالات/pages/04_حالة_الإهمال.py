...
with col_btn:
    run_neglect = st.button("🚀 بدء فحص الإهمال الآن", type="primary", use_container_width=True)

# ─────────────────────────────────────────────────────────────
# 1. فحص فائق السرعة (< 0.03s)
# ─────────────────────────────────────────────────────────────
if run_neglect:
    with st.spinner("جاري احتساب أيام الإهمال..."):
        if NeglectEngine:
            ...
            st.error("محرك الإهمال غير متوفر")
            st.stop()
...
if result:
    ...
    # ─────────────────────────────────────────────────────────────
    # 2. أزرار تنزيل مباشرة بدون إخفاء أو لودينغ مسبق
    # ─────────────────────────────────────────────────────────────
    ...
    st.info("👆 اضغط على زر **'🚀 بدء فحص الإهمال الآن'** لعرض التحليل وأزرار التحميل.")
